...
if __name__ == '__main__':
    test_test('GAMENet_12_13_train_0.3.txt')
    ...
    # for i in range(10):
    #     ddi_rate, ja, prauc, avg_p, avg_r, avg_f1 = train(LR=0.9982738708681028, emb_dims=128,
    #                                                       l2_regularization=7.80653319131116e-05)
