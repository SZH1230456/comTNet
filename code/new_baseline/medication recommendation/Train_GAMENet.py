...
if __name__ == '__main__':
    test_test('GAMENet_12_14_test_前几次数据_0.3.txt')
    ...
    for i in range(10):
        ddi_rate, ja, prauc, avg_p, avg_r, avg_f1 = train(LR=0.5243345089272472, emb_dims=128,
                                                          l2_regularization=2.3483542145749728e-07)
